...
function SplitFlapChar({ char, index, animationKey, skipEntrance, speed, playClick }: SplitFlapCharProps) {
  ...
  const bgColor = isSettled ? "var(--background)" : "oklch(0.650 0.173 262.72 / 0.2)"
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden flex items-center justify-center font-[family-name:var(--font-inter)]"
      style={{
        width: "0.65em",
        height: "1.05em",
